object frmPermissoesAnalise: TfrmPermissoesAnalise
  Left = 483
  Top = 223
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Permiss'#245'es da An'#225'lise'
  ClientHeight = 388
  ClientWidth = 464
  Color = clBtnFace
  ...
  object Label1: TcxLabel
    Left = 8
    Top = 8
    Caption = 'Quem pode VISUALIZAR'
    Transparent = True
  end
  object Label3: TcxLabel
    Left = 8
    Top = 80
    Caption = 'Quem pode ALTERAR'
    Transparent = True
  end
  object Label4: TcxLabel
    Left = 8
    Top = 152
    Caption = 'Quem pode APAGAR'
    Transparent = True
  end
  object Label5: TcxLabel
    Left = 8
    Top = 225
    Caption = 'Quem pode ATUALIZAR'
    Transparent = True
  end
  object Label6: TcxLabel
    ...
    Top = 300
    Caption = 
      'INSTRU'#199#213'ES: Informe * para indicar todos os usu'#225'rios. Para negar' +
      ' permiss'#227'o informe  #'
    ParentFont = False
  ...
  object Label7: TcxLabel
    ...
    Top = 314
    Caption = 
      'antes do nome do usu'#225'rio, como por exemplo, #usuario. Informe os' +
      ' nomes'
    ParentFont = False
    Style.Font.Charset = DEFAULT_CHARSET
    Style.Font.Color = clGreen
  ...
  object Label8: TcxLabel
    Left = 83
    Top = 329
    Caption = 'de usu'#225'rios separados por , (virgula).'
    ParentFont = False
    Style.Font.Charset = DEFAULT_CHARSET
    Style.Font.Color = clGreen
    Style.Font.Height = -11
