object frmCadFotografia: TfrmCadFotografia
  Left = 38
  Top = 69
  BorderIcons = [biSystemMenu, biMinimize]
  Caption = 'An'#225'lises Fotogr'#225'ficas'
  ClientHeight = 441
  ClientWidth = 682
  Color = clBtnFace
  ...
  object cxGrid1: TcxGrid
    ...
    object cxGrid1DBTableView1: TcxGridDBTableView
      ...
      DataController.DataSource = dtsFotografia
      ...
      object cxGrid1DBTableView1DBColumn1: TcxGridDBColumn
        ...
        DataBinding.FieldName = 'ID_FOTOGRAFIA'
        SortIndex = 0
  ...
  object DBEdit1: TcxDBTextEdit
    ...
    Top = 24
    TabStop = False
    DataBinding.DataField = 'ID_FOTOGRAFIA'
    DataBinding.DataSource = dtsFotografia
    TabOrder = 1
    Width = 315
  end
  ...
  object dtsFotografia: TDataSource
    AutoEdit = False
    DataSet = tblFotografia
    Left = 624
    Top = 8
  end
  ...
  object tblFotografia: TADOTable
    Connection = bdDados
    CursorLocation = clUseServer
    BeforePost = tblFotografiaBeforePost
    BeforeDelete = tblFotografiaBeforeDelete
