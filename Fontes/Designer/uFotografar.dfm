object frmFotografar: TfrmFotografar
  Left = 250
  Top = 161
  ...
  object Label3: TcxLabel
    Left = 9
    Top = 102
    Caption = 'Fotografar o Per'#237'odo'
    Transparent = True
  end
  ...
  object Label6: TcxLabel
    Left = 9
    Top = 150
    Caption = 'Comparar com o Per'#237'odo'
    Transparent = True
  end
