object frmCriaDynamics: TfrmCriaDynamics
  Left = 182
  Top = 101
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Criar Dynamics'
  ClientHeight = 289
  ClientWidth = 536
  Color = clBtnFace
  ...
  object Label5: TcxLabel
    Left = 8
    Top = 52
    Caption = 'Descri'#231#227'o do Dynamics'
    Transparent = True
  end
  ...
  object tblDynamics: TADOTable
    Connection = frmDesigner.bdDados
    ...
    object tblDynamicsSQL: TMemoField
      FieldName = 'SQL'
      BlobType = ftMemo
    end
