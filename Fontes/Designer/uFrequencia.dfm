object frmFrequencia: TfrmFrequencia
  ...
  object Label1: TcxLabel
    Left = 8
    Top = 8
    Caption = 'Informe o campo que dever'#225' ser utilizado como fator de Data:'
    Transparent = True
  end
  object Label2: TcxLabel
    Left = 8
    Top = 56
    Caption = 'Informe o campo que dever'#225' ser utilizado como fator de Valor:'
    Transparent = True
  end
  object Label3: TcxLabel
    Left = 9
    Top = 102
    Caption = 'Considerar o seguinte per'#237'odo na an'#225'lise de freq'#252#234'ncia'
    ParentFont = False
  ...
  object Label6: TcxLabel
    Left = 9
    Top = 164
    Caption = 'Data Base da Freq'#252#234'ncia'
    Transparent = True
  end
  ...
  object edtDias: TcxCurrencyEdit
    Left = 151
    Top = 180
  ...
  object chkAtual: TcxCheckBox
    Left = 8
    Top = 205
    Caption = 'Usar Data Atual'
    TabOrder = 6
    Transparent = True
    OnClick = chkAtualClick
    Width = 121
  end
end
