object frmFiltro: TfrmFiltro
  ...
  object qryFiltro: TADOQuery
    Connection = dtmPrincipal.bdArmazena
  ...
  object tblCenariosDynamics: TADOTable
    Connection = dtmPrincipal.bdDados
    CursorLocation = clUseServer
    BeforePost = tblCenariosDynamicsBeforePost
    TableName = 'CENARIOS_DYNAMICS'
    Left = 256
    Top = 184
    object tblCenariosDynamicsID_CENARIO_DYNAMICS: TWideStringField
      FieldName = 'ID_CENARIO_DYNAMICS'
      Size = 50
    end
    object tblCenariosDynamicsID_DYNAMICS: TWideStringField
      FieldName = 'ID_DYNAMICS'
      Size = 50
    end
    object tblCenariosDynamicsID_USUARIO: TWideStringField
      FieldName = 'ID_USUARIO'
      Size = 50
    end
    object tblCenariosDynamicsVALOR: TBlobField
      FieldName = 'VALOR'
    end
    object tblCenariosDynamicsFILTRO: TWideMemoField
      FieldName = 'FILTRO'
      BlobType = ftWideMemo
    end
    object tblCenariosDynamicsFILTRO_COMPONENTE: TBlobField
      FieldName = 'FILTRO_COMPONENTE'
    end
  end
end
