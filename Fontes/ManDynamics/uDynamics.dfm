object frmDynamics: TfrmDynamics
  Left = 76
  Top = 158
  ...
  object cxGrid1: TcxGrid
    ...
    object cxGrid1DBTableView1: TcxGridDBTableView
      ...
      DataController.DataSource = dtsDynamics
      ...
      object cxGrid1DBTableView1DBColumn1: TcxGridDBColumn
        Caption = 'Dynamics'
        DataBinding.FieldName = 'ID_DYNAMICS'
        SortIndex = 0
  ...
  object DBEdit1: TcxDBTextEdit
    ...
    Top = 24
    TabStop = False
    DataBinding.DataField = 'ID_DYNAMICS'
    DataBinding.DataSource = dtsDynamics
    TabOrder = 1
    Width = 315
  end
  ...
  object cxDBCheckBox1: TcxDBCheckBox
    ...
    Top = 364
    TabStop = False
    Caption = 'Mostrar Formul'#225'rio de Filtro'
    DataBinding.DataField = 'PEDE_FILTRO'
    DataBinding.DataSource = dtsDynamics
  ...
  object dtsDynamics: TDataSource
    AutoEdit = False
    DataSet = tblDynamics
    Left = 624
    Top = 8
  ...
  object tblDynamics: TADOTable
    Connection = bdDados
    CursorLocation = clUseServer
    BeforePost = tblDynamicsBeforePost
    BeforeDelete = tblDynamicsBeforeDelete
    OnFilterRecord = tblDynamicsFilterRecord
    TableName = 'DYNAMICS'
    Left = 560
    Top = 8
    object tblDynamicsID_DYNAMICS: TWideStringField
      FieldName = 'ID_DYNAMICS'
      Size = 50
    end
    object tblDynamicsID_ANALISE: TWideStringField
      FieldName = 'ID_ANALISE'
      Size = 50
    end
    object tblDynamicsDESCRICAO: TMemoField
      FieldName = 'DESCRICAO'
      BlobType = ftMemo
    end
    object tblDynamicsPODE_VISUALIZAR: TMemoField
      FieldName = 'PODE_VISUALIZAR'
      BlobType = ftMemo
    end
    object tblDynamicsPODE_ALTERAR: TMemoField
      FieldName = 'PODE_ALTERAR'
      BlobType = ftMemo
    end
    object tblDynamicsPODE_APAGAR: TMemoField
      FieldName = 'PODE_APAGAR'
      BlobType = ftMemo
    end
    object tblDynamicsPEDE_FILTRO: TWideStringField
      FieldName = 'PEDE_FILTRO'
      Size = 1
    end
    object tblDynamicsDT_CRIACAO: TDateTimeField
      FieldName = 'DT_CRIACAO'
    end
    object tblDynamicsSQL: TWideMemoField
      FieldName = 'SQL'
      BlobType = ftWideMemo
    end
  end
