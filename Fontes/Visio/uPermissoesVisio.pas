...
type
  TfrmPermissoesVisio = class(TForm)
...
var
  frmPermissoesVisio: TfrmPermissoesVisio;
...
procedure TfrmPermissoesVisio.FormClose(Sender: TObject;
...
procedure TfrmPermissoesVisio.SpeedButton1Click(Sender: TObject);
begin
    close;
end;

procedure TfrmPermissoesVisio.FormShow(Sender: TObject);
begin
    Memo1.Lines.Clear;
    Memo3.Lines.Clear;
    Memo4.Lines.Clear;

    Memo1.Lines.Text := frmVisio.tblVisioPODE_VISUALIZAR.Value;
    Memo3.Lines.Text := frmVisio.tblVisioPODE_ALTERAR.Value;
    Memo4.Lines.Text := frmVisio.tblVisioPODE_APAGAR.Value;

    GeraLog(frmVisio.bdDados,frmVisio.sUsuario,Self.Name,HCLResourceStrings.FindID('sString_355'),Self.Caption);
end;

procedure TfrmPermissoesVisio.SpeedButton3Click(Sender: TObject);
begin
    ...
    frmVisio.tblVisioPODE_VISUALIZAR.Value := Memo1.Lines.Text;
    frmVisio.tblVisioPODE_ALTERAR.Value    := Memo3.Lines.Text;
    frmVisio.tblVisioPODE_APAGAR.Value     := Memo4.Lines.Text;
