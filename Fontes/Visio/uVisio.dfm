object frmVisio: TfrmVisio
  ...
  object cxGrid1: TcxGrid
    ...
    object cxGrid1DBTableView1: TcxGridDBTableView
      ...
      DataController.DataSource = dtsVisio
      ...
      object cxGrid1DBTableView1DBColumn1: TcxGridDBColumn
        Caption = 'Visio'
        DataBinding.FieldName = 'ID_VISIO'
        SortIndex = 0
  ...
  object DBEdit1: TcxDBTextEdit
    ...
    Top = 24
    TabStop = False
    DataBinding.DataField = 'ID_VISIO'
    DataBinding.DataSource = dtsVisio
    TabOrder = 1
    Width = 315
  end
  ...
  object tblVisio: TADOTable
    Connection = bdDados
    CursorLocation = clUseServer
    BeforePost = tblVisioBeforePost
    BeforeDelete = tblVisioBeforeDelete
    OnFilterRecord = tblVisioFilterRecord
    TableName = 'VISIO'
    Left = 552
    Top = 8
    object tblVisioID_VISIO: TWideStringField
      FieldName = 'ID_VISIO'
      Size = 50
    end
    object tblVisioDESCRICAO: TWideMemoField
      FieldName = 'DESCRICAO'
      BlobType = ftWideMemo
    end
    object tblVisioARQUIVO: TWideStringField
      FieldName = 'ARQUIVO'
      Size = 255
    end
    object tblVisioPODE_VISUALIZAR: TWideMemoField
      FieldName = 'PODE_VISUALIZAR'
      BlobType = ftWideMemo
    end
    object tblVisioPODE_ALTERAR: TWideMemoField
      FieldName = 'PODE_ALTERAR'
      BlobType = ftWideMemo
    end
    object tblVisioPODE_APAGAR: TWideMemoField
      FieldName = 'PODE_APAGAR'
      BlobType = ftWideMemo
    end
    object tblVisioDT_CRIACAO: TDateTimeField
      FieldName = 'DT_CRIACAO'
    end
    object tblVisioGRUPO: TWideStringField
      FieldName = 'GRUPO'
      Size = 50
    end
  end
