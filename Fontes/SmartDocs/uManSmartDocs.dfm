object frmManSmartDocs: TfrmManSmartDocs
  Left = 129
  Top = 204
  ...
  object cxButton1: TcxButton
    ...
    Width = 337
    Height = 33
    Caption = 'Clique para importar o arquivo do SmartDocs'
    ParentShowHint = False
    ShowHint = False
    TabOrder = 7
    Visible = False
  ...
  object edtPlanilha: TcxMaskEdit
    Left = 366
    Top = 71
  ...
  object cxLabel1: TcxLabel
    Left = 366
    Top = 55
    Caption = 'Planilha Dados'
    Transparent = True
  end
  object cxLabel2: TcxLabel
    Left = 8
    Top = 145
    Caption = 'Complemento do SQL'
    Transparent = True
  end
  ...
  object OpenDialog1: TOpenDialog
    Options = [ofReadOnly, ofOverwritePrompt, ofHideReadOnly, ofShowHelp, ofAllowMultiSelect, ofExtensionDifferent, ofPathMustExist, ofFileMustExist, ofCreatePrompt, ofShareAware, ofEnableIncludeNotify, ofEnableSizing, ofDontAddToRecent, ofForceShowHidden]
    Left = 16
    Top = 400
  end
  object tblAnalises: TADOTable
    Connection = frmSmartDocs.bdDados
    ...
    object tblAnalisesDESCRICAO: TWideMemoField
      FieldName = 'DESCRICAO'
      BlobType = ftWideMemo
    end
    object tblAnalisesBASE_ORIGEM: TWideMemoField
    ...
    object tblAnalisesPODE_VISUALIZAR: TWideMemoField
      FieldName = 'PODE_VISUALIZAR'
      BlobType = ftWideMemo
    end
    object tblAnalisesPODE_ALTERAR: TWideMemoField
      FieldName = 'PODE_ALTERAR'
      BlobType = ftWideMemo
    end
    object tblAnalisesPODE_ATUALIZAR: TWideMemoField
      FieldName = 'PODE_ATUALIZAR'
      BlobType = ftWideMemo
    end
    object tblAnalisesPODE_APAGAR: TWideMemoField
    ...
    object tblAnalisesANALISES_IGNORADOS: TWideMemoField
      FieldName = 'ANALISES_IGNORADOS'
      BlobType = ftWideMemo
    end
    object tblAnalisesVALORES_IGNORADOS: TWideMemoField
