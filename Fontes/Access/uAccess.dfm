object frmAccess: TfrmAccess
  ...
  object cxGrid1: TcxGrid
    ...
    object cxGrid1DBTableView1: TcxGridDBTableView
      ...
      DataController.DataSource = dtsAccess
      ...
      object cxGrid1DBTableView1DBColumn1: TcxGridDBColumn
        Caption = 'Access'
        DataBinding.FieldName = 'ID_ACCESS'
        SortIndex = 0
  ...
  object DBEdit1: TcxDBTextEdit
    ...
    Top = 24
    TabStop = False
    DataBinding.DataField = 'ID_ACCESS'
    DataBinding.DataSource = dtsAccess
    TabOrder = 1
    Width = 315
  end
  ...
  object tblAccess: TADOTable
    Connection = bdDados
    CursorLocation = clUseServer
    BeforePost = tblAccessBeforePost
    BeforeDelete = tblAccessBeforeDelete
    OnFilterRecord = tblAccessFilterRecord
    TableName = 'ACCESS'
    Left = 560
    Top = 8
    object tblAccessID_ACCESS: TWideStringField
      FieldName = 'ID_ACCESS'
      Size = 50
    end
    object tblAccessDESCRICAO: TWideMemoField
      FieldName = 'DESCRICAO'
      BlobType = ftWideMemo
    end
    object tblAccessARQUIVO: TWideStringField
      FieldName = 'ARQUIVO'
      Size = 255
    end
    object tblAccessMACRO: TWideStringField
      FieldName = 'MACRO'
      Size = 255
    end
    object tblAccessPODE_VISUALIZAR: TWideMemoField
      FieldName = 'PODE_VISUALIZAR'
      BlobType = ftWideMemo
    end
    object tblAccessPODE_ALTERAR: TWideMemoField
      FieldName = 'PODE_ALTERAR'
      BlobType = ftWideMemo
    end
    object tblAccessPODE_APAGAR: TWideMemoField
      FieldName = 'PODE_APAGAR'
      BlobType = ftWideMemo
    end
    object tblAccessDT_CRIACAO: TDateTimeField
      FieldName = 'DT_CRIACAO'
    end
    object tblAccessGRUPO: TWideStringField
      FieldName = 'GRUPO'
      Size = 50
    end
  end
