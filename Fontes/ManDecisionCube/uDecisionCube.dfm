object frmDecisionCube: TfrmDecisionCube
  ...
  object grd1: TcxGrid
    ...
    object grd1DBTableView1: TcxGridDBTableView
      ...
      DataController.DataSource = dtsDecisionMySQL
      DataController.Summary.DefaultGroupSummaryItems = <>
      DataController.Summary.FooterSummaryItems = <>
      DataController.Summary.SummaryGroups = <>
      OptionsBehavior.IncSearch = True
      OptionsBehavior.IncSearchItem = grd1DBTableView1DBColumn1
      ...
      object grd1DBTableView1DBColumn1: TcxGridDBColumn
        Caption = 'Decision Cube'
        DataBinding.FieldName = 'ID_DECISION'
        SortIndex = 0
        SortOrder = soAscending
        Width = 221
      end
      object grd1DBTableView1Column1: TcxGridDBColumn
        Caption = 'Grupo'
  ...
  object DBEdit1: TcxDBTextEdit
    ...
    Top = 24
    TabStop = False
    DataBinding.DataField = 'ID_DECISION'
    DataBinding.DataSource = dtsDecisionMySQL
    TabOrder = 1
    Width = 315
  end
  ...
  object dtsDecisionMySQL: TDataSource
    AutoEdit = False
    DataSet = tblDecision
    Left = 624
    Top = 8
  ...
  object tblDecision: TADOTable
    ...
    BeforePost = tblDecisionBeforePost
    BeforeDelete = tblDecisionBeforeDelete
    OnFilterRecord = tblDecisionFilterRecord
    TableName = 'DECISION'
    Left = 560
    Top = 8
    ...
    object tblDecisionGRUPO: TWideStringField
      FieldName = 'GRUPO'
      Size = 50
    end
  end
