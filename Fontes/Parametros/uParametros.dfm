object frmParametros: TfrmParametros
  ...
  object cxLabel2: TcxLabel
    Left = 8
    Top = 8
    Caption = 'Vers'#227'o Base Dados:'
    Transparent = True
  end
  object cxDBTextEdit1: TcxDBTextEdit
    Left = 8
    Top = 24
    DataBinding.DataField = 'VERSAO_BASE'
  ...
  object cxDBTextEdit2: TcxDBTextEdit
    Left = 8
    Top = 67
    DataBinding.DataField = 'SERVIDOR_MAIL'
    DataBinding.DataSource = DataSource1
    TabOrder = 5
    Width = 403
  end
  object cxLabel3: TcxLabel
    Left = 8
    Top = 96
    Caption = 'Porta do Email:'
    Transparent = True
  end
  object cxDBTextEdit3: TcxDBTextEdit
    Left = 8
    Top = 112
    DataBinding.DataField = 'PORTA_MAIL'
    DataBinding.DataSource = DataSource1
    TabOrder = 7
    Width = 121
  end
  ...
  object cxDBTextEdit4: TcxDBTextEdit
    Left = 290
    Top = 24
    DataBinding.DataField = 'COD_PARAMETRO'
    DataBinding.DataSource = DataSource1
    Enabled = False
    TabOrder = 3
    Width = 121
  ...
  object cxDBMemo1: TcxDBMemo
    Left = 8
    Top = 199
    DataBinding.DataField = 'MAIL_MENSAGEM'
    DataBinding.DataSource = DataSource1
  ...
  object cxLabel7: TcxLabel
    Left = 8
    Top = 382
    Caption = 'Dt. Limite Atualiza'#231#227'o:'
    Transparent = True
  end
  object cxDBDateEdit1: TcxDBDateEdit
    Left = 8
    Top = 400
    DataBinding.DataField = 'DT_LIMITE_ATUALIZACAO'
    DataBinding.DataSource = DataSource1
  ...
  object cxDBCheckBox1: TcxDBCheckBox
    ...
    DataBinding.DataField = 'UTILIZAR_SSL'
    DataBinding.DataSource = DataSource1
  ...
  object tblParametros: TADOTable
    ...
    object tblParametrosDT_LIMITE_ATUALIZACAO: TDateTimeField
      FieldName = 'DT_LIMITE_ATUALIZACAO'
      ProviderFlags = [pfInUpdate]
    end
    object tblParametrosMAIL_ASSUNTO: TWideStringField
      FieldName = 'MAIL_ASSUNTO'
      ProviderFlags = [pfInUpdate]
      Size = 100
    end
    object tblParametrosMAIL_MENSAGEM: TWideStringField
      FieldName = 'MAIL_MENSAGEM'
      ProviderFlags = [pfInUpdate]
      Size = 500
    end
    object tblParametrosCOD_PARAMETRO: TIntegerField
      FieldName = 'COD_PARAMETRO'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
    end
    object tblParametrosUTILIZAR_SSL: TBooleanField
      FieldName = 'UTILIZAR_SSL'
    end
  end
end
